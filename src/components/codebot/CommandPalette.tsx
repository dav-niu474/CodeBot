    ...
    <AnimatePresence mode="wait">
      {open && (
        <>
          ...
          >
            <div className="overflow-hidden rounded-xl border border-border/50 bg-zinc-900/95 shadow-2xl shadow-black/40 backdrop-blur-xl">
              {/* ── Search Input ────────────── */}
              <div className="flex items-center gap-3 border-b border-border/50 px-4 py-3">
                ...
                />
                <kbd className="hidden items-center gap-1 rounded-md border border-border/50 bg-zinc-800/80 px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground sm:inline-flex">
                  ESC
                </kbd>
              </div>
                                ...
                                <kbd
                                  className={cn(
                                    ...
                                    isSelected
                                      ...
                                      : 'border-border/50 bg-zinc-800/60 text-muted-foreground/60'
                                  )}
                                >
                                  {item.shortcut}
                                </kbd>
              ...
              <div className="flex items-center justify-between border-t border-border/50 px-4 py-2.5">
                <div className="flex items-center gap-3 text-[10px] text-muted-foreground/50">
                  <span className="flex items-center gap-1">
                    <kbd className="rounded border border-border/40 bg-zinc-800/60 px-1 py-0.5 font-mono text-[9px]">
                      ↑↓
                    </kbd>
                    Navigate
                  </span>
