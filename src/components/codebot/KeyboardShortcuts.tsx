      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            transition={{ duration: 0.15 }}
            className="relative mx-4 max-w-md w-full rounded-xl border border-border/50 bg-zinc-900 p-6 shadow-2xl"
          >
            {/* Header */}
                      ...
                      >
                        ...
                        <div className="flex items-center gap-1">
                          {shortcut.keys.map((key, idx) => (
                            <span key={key}>
                              <kbd className="bg-zinc-800 border border-zinc-700 rounded px-1.5 py-0.5 text-[11px] font-mono text-muted-foreground">
                                {key}
                              </kbd>
            ...
            <div className="mt-4 border-t border-border/50 pt-3 text-center">
              <span className="text-[10px] text-muted-foreground/60">
                Press <kbd className="bg-zinc-800 border border-zinc-700 rounded px-1.5 py-0.5 text-[11px] font-mono text-muted-foreground">?</kbd> to toggle
              </span>
            </div>
          </motion.div>
        </motion.div>
