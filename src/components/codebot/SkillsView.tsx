                                  ...
                                  <div className="flex shrink-0 items-center gap-1.5 mt-0.5">
                                    ...
                                    {skill.isEnabled && (
                                      <button
                                        ...
                                        className="flex h-6 w-6 items-center justify-center rounded-md text-muted-foreground/50 hover:text-emerald-400 hover:bg-emerald-500/10 transition-colors"
                                        title="Use in Chat"
                                      >
