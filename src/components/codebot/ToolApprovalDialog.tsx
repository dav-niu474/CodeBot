...
import {
  ...
  RefreshCw, Plane, Play, Zap, Clock,
} from 'lucide-react';
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
            ...
            <div>
              ...
              <AnimatePresence>
                {expanded && (
                  ...
                  >
                    <pre className="mt-2 rounded-lg border border-border/30 bg-popover/80 p-3 text-[11px] font-mono text-muted-foreground/80 whitespace-pre-wrap break-all max-h-48 overflow-y-auto">
                      {formattedArgs}
                    </pre>
                  </motion.div>
                )}
          ...
          {/* Action buttons */}
          <div className="flex items-center gap-2 border-t border-border/30 px-5 py-3.5 bg-popover/40 rounded-b-xl">
            <Button
              size="sm"
              variant="ghost"
              onClick={onDeny}
