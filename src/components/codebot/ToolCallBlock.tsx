          ...
          >
            <div className="border-t border-border/30 px-3 py-2 space-y-2">
              ...
              <div>
                ...
                <pre className="rounded-md border border-border/30 bg-popover/80 p-2 text-[11px] font-mono text-muted-foreground/80 whitespace-pre-wrap break-all max-h-32 overflow-y-auto">
                  {(() => {
                    try {
