                  ...
                  {commits.length === 0 ? (
                    ...
                    commits.map((commit, i) => (
                      <motion.div
                        ...
                        className="group flex items-start gap-3 px-4 py-3 transition-colors hover:bg-zinc-800/30"
                      >
                        {/* Author Avatar */}
                        <div
                        ...
                        <button
                          ...
                          className="shrink-0 rounded p-1 text-muted-foreground/0 transition-all hover:bg-zinc-800 hover:text-muted-foreground group-hover:text-muted-foreground/30"
                  ...
                  <div className="max-h-48 overflow-y-auto divide-y divide-border/30">
                    {remoteBranches.map((branch, i) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.15, delay: i * 0.02 }}
                        className="flex items-center gap-3 px-4 py-2 transition-colors hover:bg-zinc-800/30"
                      >
